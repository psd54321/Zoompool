...
now = datetime.now()
directions_result = gmaps.directions("40.61862, -74.03071",
                                     "40.70609, -73.99686",
                                     mode="driving",
                                     departure_time=now)

#print directions_result
poly = polyline.decode(directions_result[0]['overview_polyline']['points'])
...
print getMiles(bdccGeoDistanceToPolyMtrs(poly, 40.63241, -74.02958))